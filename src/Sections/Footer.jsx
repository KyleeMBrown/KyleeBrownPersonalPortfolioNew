  ...
  return (
    <div className="p-[1em] text-gray-500 mt-2 bg-[#cdeaeb]">
      <Group justify="space-evenly" style={{width:"100%"}}>
        ...
        <a target='_blank' className="hover:scale-103 active:scale-100 underline text-[0.7em]" href="https://github.com/KyleeMBrown/KyleeBrownPersonalPortfolioNew"><p>Source Code</p></a>
        </Group>
        <Group gap={3}>
